...
from src.utils.graphical_utils import Frame, Label, DateEntry
...
def custom_drop_down(self):
        ...
        if self._calendar.winfo_ismapped():
            ...
            x = self.winfo_rootx()
            y = self.winfo_rooty() - 200 + self.winfo_height()
...
class SchedulePicker(Frame):
    ...
    def __init__(self, manager:Frame):
        ...
        Label(self, text="Schedule", bg="#494466", fg="white").pack(side='top')

        # start date
        start_date_frame = Frame(self, bg="white")
        ...
        # end date
        end_date_frame = Frame(self, bg="white")
